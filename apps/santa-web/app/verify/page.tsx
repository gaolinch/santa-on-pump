...
export const metadata = buildMetadata({
  title: 'Verify Gifts',
  description: 'Verify the cryptographic proofs for daily gift reveals',
  path: '/verify',
})
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
          All 24 gifts were committed before December 1st using a Merkle tree. 
          Each day, we reveal one gift along with its cryptographic proof. 
          You can verify that any revealed gift was part of the original commitment.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              A Merkle tree is a cryptographic data structure that allows efficient verification 
              of data integrity. Each leaf represents a hash of a gift, and parent nodes are 
              hashes of their children, up to a single root hash.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              ...
              we cryptographically commit to all 24 gifts. We cannot change them later, but we can 
              reveal them one at a time while proving each was part of the original commitment.
            </p>
          </div>
        </div>
